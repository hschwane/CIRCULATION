...
__global__ void mirrorBoundariesGPU(int numBoundCellsY, int  numBoundCellsX, csT coordinateSystem, gridRefT grid)
{
...
void handleMirroredBoundaries(bool boundX, bool boundY, csT& cs, gridT& grid)
{
    ...
    mirrorBoundariesGPU<attributeType><<<numBlocks, blocksize>>>(numBoundCellsY,numBoundCellsX,cs,grid.getGridReference());
}
